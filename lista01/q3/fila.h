...
/* função que crie uma fila com os elementos da fila f na ordem inversa. */
Fila *inverte(Fila *f);
/* função para retornar o número de elementos da fila que possuem o campo info com valor par. */
int pares(Fila *f);
